...
Sessions allow the user to stay logged in, even when they do exit the page or reload it.
...
It hashes the password how ever many times you tell it to slow attackers.
